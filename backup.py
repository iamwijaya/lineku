...
cl.login(token="EoTGV9ougodlM1JRYmg2.WCCRkMNgQXINSOQNF/5yiG.usJ0e1JD8r0Ci9K6o/nL+46Z7VEmR8OtqwXuxil3Xmg=")
cl.loginResult()
...
wait = {
    ...
    'leaveRoom':False,
    'autoAdd':False,
    'message':"Terimakasih telah menambahkan saua sebagai teman anda",
    "lonte":False,
    "responpc":False,
    "kickMention":False,
    "lang":"JP",
