...
cl.login(token="EowLxBNAEZNogby08K22.WCCRkMNgQXINSOQNF/5yiG.kCIvO8UKv1hfVITwSIhgdSstnUAAE+Dl8JKfalyO8tg=")
cl.loginResult()

ki = LineAlpha.LINE() #0
ki.login(token="EogbuW6jl6vuwfdzz5Lc.iPVblK8oEfqifUIij+vu7a.HOskadTB7H3sL89bN/s/k6d6M2THQBeuBeYImRZ9rHg=")
ki.loginResult()

kk = LineAlpha.LINE()#2
kk.login(token="EoCt4g8EaR3n7uu1bDdb.Y+GAPFJThIZhZk7qpgaJEW.myhiPJHcq23w4HjyqwN3hK793BZB79doohaNV/2BwNo=")
kk.loginResult()

kc = LineAlpha.LINE()#3
kc.login(token="Eom5POHPTIz2itRRfKJb.9cLvUfhrGJx1lyydmxgBcW.Q0q2zeTEvFe3RvXN93Xr6rpQfP3nLxCQMWAjH8DFxUI=")
kc.loginResult()

ke = LineAlpha.LINE()#4
ke.login(token="EoFhaqlKvIAA4aMSSMOf.iC4lfEriEzKXeWEY6lQf+W.UfRUMiWZqHGMuOlpGySHYVx83fTdi00BPNmomsOEfpg=")
ke.loginResult()

kb = LineAlpha.LINE() #5
kb.login(token="EoiZAtmoqJIXVe3gxeef.AzOxSrYUoRO+s8R0wGFDNW.HGnFCL8oaEqi1qAFsWPCE8cY8p1On6fJmjgrq8QZirc=")
kb.loginResult()

ks = LineAlpha.LINE()#6
ks.login(token="EosmCOchI9vVxQJNV4k2.zz02fzUHgHMt43YFBMIUuG.ts2q7pkQKfRAt8Tkv9BzL9ZIlblV/TUIJPzAY77/m2I=")
ks.loginResult()

ka = LineAlpha.LINE()#7
ka.login(token="EoSgdqvUtfuaI3u0D1m1.6FEeUgZiJRekuif7AJkoyq./oIw5v+LmzVutkkoXsbrA9v4E28jrdAZqKhL8imfG7s=")
ka.loginResult()

ko = LineAlpha.LINE()#8
ko.login(token="Eo9Do1emTZKus4jW0BSc.WU1DIxPO+PMAGO5zAJJf+a.pSV2M7jeDfa1ZVR98jBtdoXATBsrTqcd68bIDxFfkkI=")
ko.loginResult()

ku = LineAlpha.LINE()#9
ku.login(token="EoS71yTCRaWXWBLVqN10.SIIDQHB+PWCP2bXYI9JK8a.jszF0vhHqiwa/YeAZZTbYCeYARxqmv2I4HaCOduIG6Q=")
kb.loginResult()
...
admin=["u43f99377c8388de7482e5bddd307085c","uc1c72b2a69c6ab18a7b28aa77fee5822","u229bc12e4f0e78540816e88827f554ec","ucbf81aa5f8ed1e2cc7ccaed03c60237b","u21ce0b15e4487999311307b2e8ba85ff","u699a17b11cae3aba3f4bcaf45a07dd9f","u659d36159ba11a1993e37c9f6e68ae52","ue9f784b86cc88eb10a50817b6a328e61","uc2ed5d897a68fe999a828e596a38c5fc","ub2289daa16ffa70729d81c728bd8e4f0","uf42955b851d18235f52d860331719b0b"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        if op.type == 11:
            if op.param2 not in Bots:
                if op.param2 in Bots:
                    ...
                    cl.updateGroup(G)
		    ke.sendMessage(msg.to,"招待されたユーザの中に、ブラックリストユーザとして認識されいる人がいたから、招待を取り消したよ(｀・ω・´)")
...
#---------------------------------------------#
        ...
        if op.type == 26:
            msg = op.message
            if wait["responpc"] == True:
                if msg.toType == 0:
                   cl.sendChatChecked(msg.from_,msg.id)
                   contact = cl.getContact(msg.from_)
                   cName = contact.displayName
                   balas = ["Auto respon\Ferinya sedang diluar"]
                   fer = random.choice(balas)
                   ki.sendText(msg.from_,cName)
                   ki.sendText(msg.from_,fer)
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"(・ω・）")
            elif msg.text in ["Pc on"]:
                wait["responpc"] = True
                cl.sendText(msg.to,"ヽ(・∀・)ノ")
            elif msg.text in ["Pc off"]:
                wait["responpc"] = False
                cl.sendText(msg.to,"(・ω・）")
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            kk.sendText(msg.to,"Sorry no one inviting.")
                        else:
              ...
              if msg.from_ in admin:
                ...
                if wait["responpc"] == True: md+=" 「❧ρ¢ : ヽ(・∀・)ノ」\n"
                else: md+=" 「❧ρ¢ : (・ω・）」\n"
...
#-----------------------------------------------
		    ...
		    kb.sendText(msg.to,"Just some casual cleansing ô")
                    ks.sendText(msg.to,"Just some casual cleansing ô")
                    ka.sendText(msg.to,"Just some casual cleansing ô")
                    ko.sendText(msg.to,"Just some casual cleansing ô")
		    ku.sendText(msg.to,"Just some casual cleansing ô")
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ks.sendText(msg.to,"group cleanse")
                                ka.sendText(msg.to,"group cleanse")
                                ko.sendText(msg.to,"group cleanse")
                                ku.sendText(msg.to,"group cleanse")
            elif "Nk " in msg.text:
                  if msg.from_ in admin:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ko.sendText(msg.to,"Succes ")
                                ku.sendText(msg.to,"Succes ")
                            except:
                                cl.sendText(msg.to,"Error")
                                ki.sendText(msg.to,"Error")
                                kk.sendText(msg.to,"Error")
                                kc.sendText(msg.to,"Error")
                                kb.sendText(msg.to,"Error")
                                ks.sendText(msg.to,"Error")
                                ka.sendText(msg.to,"Error")
                                ko.sendText(msg.to,"Error")
                                ku.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                kb.sendText(msg.to,"Admin Ditambahkan")
                                ks.sendText(msg.to,"Admin Ditambahkan")
                                ka.sendText(msg.to,"Admin Ditambahkan")
                                ko.sendText(msg.to,"Admin Ditambahkan")
                                ku.sendText(msg.to,"Admin Ditambahkan")
                            except:
                                pass
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                kb.sendText(msg.to,"Admin Dihapus")
                                ks.sendText(msg.to,"Admin Dihapus")
...
#======================================================
                ...
                ki.sendText(msg.to,"241")
                kk.sendText(msg.to,"Rakko v10")
                kc.sendText(msg.to,"Parry v10")
                kb.sendText(msg.to,"Doctor.A v10")
                ks.sendText(msg.to,"Eliza v10")
                ka.sendText(msg.to,"しりちゃん追加保護ボット140")
                ko.sendText(msg.to,"しりちゃん追加保護ボット140")
                ku.sendText(msg.to,"しりちゃん追加保護ボット140")
#-----------------------------------------------
...
#------------------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"Succes Clear Ban")
                kk.sendText(msg.to,"Succes Clear Ban")
                kc.sendText(msg.to,"Succes Clear Ban")
                kb.sendText(msg.to,"Succes Clear Ban")
                ks.sendText(msg.to,"Succes Clear Ban")
                ka.sendText(msg.to,"Succes Clear Ban")
                ko.sendText(msg.to,"Succes Clear Ban")
                ku.sendText(msg.to,"Succes Clear Ban")
                ...
                if wait["blacklist"] == {}:
                    ...
                    ka.sendText(msg.to,"nothing")
                    ko.sendText(msg.to,"nothing")
                    ku.sendText(msg.to,"nothing")
                else:
                    ...
                    ks.sendText(msg.to,mc)
                    ka.sendText(msg.to,mc)
                    ko.sendText(msg.to,mc)
                    ku.sendText(msg.to,mc)
                ...
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        ks.sendText(msg.to,"There was no blacklist user")
                        ka.sendText(msg.to,"There was no blacklist user")
                        ko.sendText(msg.to,"There was no blacklist user")
                        ku.sendText(msg.to,"There was no blacklist user")
                        return
                    for jj in matched_list:
                    ...
                    ks.sendText(msg.to,"Blacklist di usir")
                    ka.sendText(msg.to,"Blacklist di usir")
                    ko.sendText(msg.to,"Blacklist di usir")
                ...
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"I pretend to cancel and canceled.")
