...
nadya = LINETCR.LINE()
nadya.login(token="EoDgLPwcfPkLjpFF8yU2.WCCRkMNgQXINSOQNF/5yiG.QeV7zB+uOH/atF5sgfC7Nlcxf5Wz7kU/b6t808dM5M4=")
...
╠═════════════════════════
"""
feri="uc1c72b2a69c6ab18a7b28aa77fee5822"
...
Bots=[mid]
Creator=["uc1c72b2a69c6ab18a7b28aa77fee5822"]
    ...
    try:
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"Baper lu ya makanya leave " + nadya.getContact(op.param2).displayName +  "\nHati2 di jalan kaka,kalo jatoh pura2 push up aja biar gk malu 🤗")
        ...
        if op.type == 25:
			...
			nadya.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'uc1c72b2a69c6ab18a7b28aa77fee5822': feri}
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to, "Khusus Me")
		...
		nadya.sendText(msg.to,"Hadir!!")
              ...
              if msg.from_ in admin:
                ...
                nadya.sendText(msg.to,"Apa Manggil~Manggil Aku!?") 
                nadya.sendText(msg.to,"☆Ketik ☞Help☜ Untuk Bantuan☆") 
		...
		if msg.from_ in Creator:
		    nadya.sendText(msg.to, "「вσт нαѕ вєєи яєѕтαятє∂」")
		    restart_program()
		    print "@Restart"
		else:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'d28e13bd4u787f94cdca5457cd90efaf4': "Feri,'"}
                nadya.sendMessage(msg)
